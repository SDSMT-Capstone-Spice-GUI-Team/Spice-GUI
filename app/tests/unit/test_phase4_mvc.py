...
Moved from integration/ to unit/ as part of #772 to avoid silent CI skips.
"""
...
class TestMVCSimulationFlow:
    """Test simulation flow through MVC (netlist generation only, no ngspice)"""
...
class TestMVCErrorPropagation:
    """Test error handling across MVC layers (non-ngspice tests only)"""
