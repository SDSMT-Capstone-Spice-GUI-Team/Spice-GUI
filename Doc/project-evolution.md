...
**Outcome:** [ADR 004 - Local-First Architecture Without User Accounts](adr/004-local-first-no-user-accounts.md)
...
**Key:** MVC architecture ([ADR 005](adr/005-mvc-architecture-zero-qt-dependencies.md)) makes this evolution possible. Core logic has zero GUI dependencies, enabling future web interface if needed.
...
### Decision Phase
- [ADR 004: Local-First Architecture](adr/004-local-first-no-user-accounts.md) - The pivot decision
- [ADR 005: MVC Architecture](adr/005-mvc-architecture-zero-qt-dependencies.md) - Enables future flexibility
- [All ADRs](adr/) - Full architectural decision history
